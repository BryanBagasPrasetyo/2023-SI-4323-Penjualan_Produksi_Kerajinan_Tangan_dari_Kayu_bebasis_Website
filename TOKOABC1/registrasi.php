            ...
            <div class="col-10">
                ...
                <form action="insMember.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="hrg" name="temail" placeholder="email" required>
                    </div>
                    <div class="mb-3">
                        <label for="l4" class="form-label">Alamat</label>
                        <input type="text" class="form-control" id="jml" name="talamat" placeholder="alamat" required>
                    </div>
                    <div class="mb-3">
